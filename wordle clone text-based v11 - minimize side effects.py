#  imports:
import os       # functionality in navigating
import random   # functionality in generating pseudo-random (unsecured) numbers
import sys      # sys - for functionality to end the program

# this file path is specific to office desktop at denison location; change to suit other locations
os.chdir(r"C:\technical\python")
# other file path here
# other file path here

def instructions():    # only prints game's instructions; nothing else
...
def check_word():    # get random word, compare against guess, report results
...
DONE:
    ...
    add menu: player option to play again or quit
...
clean up functions ... how to minimize side effects
'''
